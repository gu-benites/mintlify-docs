...
import { companyName, companyBusinessName, companyAddress, companyPhone, companyEmailLink, websiteUrl } from '/snippets/company-variables.mdx';
...
We are {companyName}, doing business as {companyBusinessName} ("**Company**," "**we**," "**us**," "**our**"), a company registered in Brazil at {companyAddress}.

We operate the website [{websiteUrl}]({websiteUrl}) (the "**Site**"), the mobile application AromaCHAT GO (the "**App**"), as well as any other related products and services that refer or link to these legal terms (the "**Legal Terms**") (collectively, the "**Services**").
